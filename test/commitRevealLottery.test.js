...
contract("CommitRevealLottery", (accounts) => {
  ...
  describe("Constructor", () => {
    it("commitCloses & revealCloses should be set correctly", async () => {
      ...
      assert.equal(
        ...
        "commit closes should be block.number + duration"
      );
  ...
  describe("Enter", () => {
    it("Should revert if a player enters less than 0.01 ether", async () => {
      ...
      await truffleAssert.reverts(
        ...
        "msg.value should be greater than equal to 0.01 ether"
      ); //require문의 에러 메시지와 다르면 에러남
    });
  ...
  describe("Reveal", () => {
    it("Reveal 3 players", async () => {
      ...
      await commitRevealLottery.reveal(secret1, {
        from: accounts[1],
      });
      ...
      await commitRevealLottery.reveal(secret2, {
        from: accounts[2],
      });
      ...
      await commitRevealLottery.reveal(secret3, {
        from: accounts[3],
      });
